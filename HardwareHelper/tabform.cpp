...
TabForm::TabForm(QVector<RAM> &arr, QWidget *parent): QWidget(parent),
    ui(new Ui::TabForm)
{
    ui->setupUi(this);
...
TabForm::TabForm(QVector<Cooler> &arr, QWidget *parent): QWidget(parent),
    ui(new Ui::TabForm)
{
    ui->setupUi(this);
...
TabForm::TabForm(QVector<HDD> &arr, QWidget *parent): QWidget(parent),
    ui(new Ui::TabForm)
{
    ui->setupUi(this);
...
TabForm::TabForm(QVector<SSD> &arr, QWidget *parent): QWidget(parent),
    ui(new Ui::TabForm)
{
    ui->setupUi(this);
...
TabForm::TabForm(QVector<Power> &arr, QWidget *parent): QWidget(parent),
    ui(new Ui::TabForm)
{
    ui->setupUi(this);
...
TabForm::TabForm(QVector<Case> &arr, QWidget *parent): QWidget(parent),
    ui(new Ui::TabForm)
{
    ui->setupUi(this);
